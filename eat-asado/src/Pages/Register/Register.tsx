		...
		<FormLayout>
			...
			<div className={styles.inputSection}>
				...
				<section className={styles.secondColumn}>
					...
					<input id="confirmPassword" className={styles.registerInput} placeholder={lang.password} type="password" onChange={handleChange}/>
					<section className={styles.checkboxesContainer}>
						...
						<label className={styles.registerLabel}>
							<input id="isVegetarian" type="checkbox" className={styles.checkbox} checked={register.isVegetarian} onChange={handleCheckbox}/>
							{lang.vegetarianDiet}
						</label>

						<label className={styles.registerLabel}>
							<input id="isHypertensive" type="checkbox" className={styles.checkbox} checked={register.isHypertensive} onChange={handleCheckbox}/>
				...
				<section className={styles.buttonContainer}>
					<Button kind="primary" size="large" id="registerBtn" onClick={e => {
						e.preventDefault();
